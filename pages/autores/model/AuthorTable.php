...
require_once(__DIR__ . "/../../core/model/AbstractTable.php");
require_once(__DIR__ . "/../../conexion/conexion.php");

use Library\Core\Model\AbstractTable;
use Exception;
...
class AuthorTable extends AbstractTable
{
     ...
     * @throws Exception
     */
    public function autoresBuscarTodos()
    {
     ...
     * @throws Exception
     */
    public function autoresInsertarNuevo($nombre, $apellidos, $nacionalidad, $fechaNacimiento)
    {
        try {
     ...
     * @return array|null
     */
    public function autoresBuscarUno($idAutor)
    {
     ...
     * @throws Exception 
     */
    public function autoresActualizar($nombre, $apellidos, $nacionalidad, $fechaNacimiento, $idAutor)
    {
        try {
     ...
     * @throws Exception
     */
    public function autoresBorrar($autor)
    {
        try {
