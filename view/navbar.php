            ...
            <ul class="navbar-nav m-auto mb-2 mb-lg-0">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownAutores">
                        <li>
                            <a class="dropdown-item" href="/biblioteca/autores/listado.php">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownSocios">
                        <li>
                            <a class="dropdown-item" href="/biblioteca/socios/listado.php">
                                <i class="bi bi-list me-1"></i>Listado de socios
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="/biblioteca/socios/crear.php">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownPrestamos">
                        <li>
                            <a class="dropdown-item" href="/biblioteca/prestamos/listado.php">
                                <i class="bi bi-list me-1"></i>Listado de préstamos
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="/biblioteca/prestamos/crear.php">
