...
/**
 * Este archivo muestra el contenido html de la página a mostrar una vez borrado un nuevo elemento.
 * 
    ...
    <div class="col-12 col-xl-6 mx-md-auto my-4">
        <div class="card border-dark bg-transparent">
            <div class="card-header bg-naranja texto-verde p-3 mb-0 text-center rounded-top">
                ...
                <h5 class="card-title texto-white">El autor ha sido agregado correctamente.</h5>
            </div>
                ...
                <div class="row row-cols-1 row-cols-sm-3 g-3 px-1">
                    ...
                    <div class="col">
                        <a href="/biblioteca/autores/crear.php" class="btn btn-naranja w-100 text-uppercase py-3">
                            <i class="bi bi-plus-circle fs-1"></i><br>Crear un autor
                        </a>
                    </div>
                </div>
            </div>
