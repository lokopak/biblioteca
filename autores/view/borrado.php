    ...
    <div class="row">
        <div class="col-12 my-4 justify-content-center">
            <div class="alert alert-success text-center w-50 m-auto" role="alert">
                ...
                <p>El autor ha sido borrado correctamente.</p>
                <a href="/biblioteca/autores/listado.php" class="btn btn-success w-100 text-uppercase py-3">
                    <i class="bi bi-vector-pen me-2 fs-1"></i><br>Volver al listado de autores
                </a>
            </div>
        </div>
    </div>
